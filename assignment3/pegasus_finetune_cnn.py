...
def prepare_fine_tuning(model_name, tokenizer, train_dataset, val_dataset=None, freeze_encoder=False, output_dir='./pegasus_results'):
  """
  ...
  if val_dataset is not None:
    training_args = TrainingArguments(
      ...
      logging_dir='./pegasus_logs',            # directory for storing logs
      logging_steps=2,
